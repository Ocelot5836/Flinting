...
public class ItemModelGen implements DataProvider
{
    ...
    {
        this.generateFlatItem(ModRegistry.FLINT_SWORD.get(), ModelTemplates.FLAT_HANDHELD_ITEM);
        this.generateFlatItem(ModRegistry.FLINT_SHOVEL.get(), ModelTemplates.FLAT_HANDHELD_ITEM);
        this.generateFlatItem(ModRegistry.FLINT_PICKAXE.get(), ModelTemplates.FLAT_HANDHELD_ITEM);
        this.generateFlatItem(ModRegistry.FLINT_AXE.get(), ModelTemplates.FLAT_HANDHELD_ITEM);
        this.generateFlatItem(ModRegistry.FLINT_HOE.get(), ModelTemplates.FLAT_HANDHELD_ITEM);
        this.generateFlatItem(ModRegistry.WOOD_STRING.get(), ModelTemplates.FLAT_ITEM);
    }
